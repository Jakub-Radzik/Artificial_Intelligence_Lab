...
function minimax(board: ReversiBoard, depth: number, maximizingPlayer: boolean): number | ReversiBoard {
    console.log('minimax');
    printReversi(board);
    ...
    if (depth === 0) {
      return evaluateBoard(board, currentPlayer, heuristics.player_1.countMyPieces);
    }
